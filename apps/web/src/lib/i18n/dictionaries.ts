...
export const en = {
  ...
  auth: {
    ...
    unavailable: 'That account cannot sign in right now. Contact support.',
...
export const hi: Dictionary = {
  ...
  auth: {
    ...
    or: 'या',
    cancelled: 'साइन-इन रद्द कर दिया गया। कुछ भी नहीं बदला है।',
    unavailable: 'यह खाता अभी साइन इन नहीं कर सकता। सहायता से संपर्क करें।',
